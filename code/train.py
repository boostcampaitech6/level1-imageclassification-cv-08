...
def train(data_dir, model_dir, args):
    ...
    folds = dataset.split_dataset(n_splits=args.n_splits)
    best_val_acc = 0
    best_val_loss = np.inf
    for fold, (train_set, val_set) in enumerate(folds):
        print(f"Training on fold {fold+1}/{args.n_splits}")
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--n_splits", type=int, default=5, help="Number of folds for StratifiedKFold"
    )
