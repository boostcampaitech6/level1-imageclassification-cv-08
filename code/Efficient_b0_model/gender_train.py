...
test_data=pd.read_csv('/dataset/info.csv')
...
weight_save_path=[f'r/fold_best_model{i}.pt' for i in range(1,6)]
...
df_gender.to_csv('/my_code/df_cutmix_gender.csv', index=False)
